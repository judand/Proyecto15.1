...
public class DetalleActivityEventosAsistire extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancelar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                user.removeAll("favoritos",Arrays.asList(eventoid));
                user.saveInBackground();
                user.removeAll("interes_button",Arrays.asList(eventoid));
                user.saveInBackground();
                DetalleActivityEventosAsistire.ViewDialog alert = new ViewDialog();
                alert.showDialog(DetalleActivityEventosAsistire.this, "Has cancelado correctamente tu asistencia");
                startActivity(new Intent(DetalleActivityEventosAsistire.this, EventosDrawActivity.class));
            }
        });
